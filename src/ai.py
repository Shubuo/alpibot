...
def generate_analysis(game_stats: dict, milestones: list[str], averages: dict = None) -> dict:
    """Veri odaklı ve nesnel analiz üretir (Hata korumalı)."""
    if not GOOGLE_AI_API_KEY:
        return {
            "tr": "İstatistiksel olarak istikrarlı bir performans. Alperen takımına katkı vermeye devam ediyor.",
            "en": "Statistically consistent performance. Alpi continues to contribute."
        }
    ...
    try:
        ...
        return {
            "tr": "Alperen yine sahanın her yerinde. İstatistiksel olarak verimli bir geceyi geride bıraktı.",
            "en": "Alpi was everywhere again. He completed a statistically efficient night."
        }
